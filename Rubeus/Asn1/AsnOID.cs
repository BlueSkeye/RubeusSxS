...
namespace Asn1
{
    public class AsnOID
    {
	    static AsnOID()
	    {
		    ...
		    /* These are the "right" OID. RFC 5280 mistakenly defines the first OID element as "2". */
	    ...
	    private static bool IsNumericOID(string oid)
	    {
        ...
        private static Dictionary<string, string> OIDToName = new Dictionary<string, string>();
        private static Dictionary<string, string> NameToOID = new Dictionary<string, string>();
    }
}
